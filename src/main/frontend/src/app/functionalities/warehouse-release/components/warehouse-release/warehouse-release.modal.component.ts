...
@Component({
    ...
    <form [formGroup]="form" class="d-flex flex-column justify-content-center align-items-center">
      <div class="row mb-3 mt-1" style="width: 99%">
        ...
        <mat-form-field class="col-sm-6">
          ...
          <input matInput [matDatepicker]="picker2" disabled formControlName="wzCreatedDate">
  ...
  `,
  styleUrls: ['./warehouse-release.modal.component.scss']
})

export class WarehouseReleaseModalComponent implements OnInit {
  form: FormGroup;
  ...
  constructor(public dialogRef: MatDialogRef<WarehouseReleaseModalComponent>,
